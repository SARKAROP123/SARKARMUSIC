        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="✯ вαϲк ✯", callback_data="_back"),
                    ],
                ]
            ),
        )
    elif query.data == "sarkar":
        first_name = update.effective_user.first_name 
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), (START_IMG), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
...
""",
            ...
            [
                InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="✯ вαϲк ✯", callback_data="sarkar"),
                    ],
                ]
           ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} 𝐋𝐀𝐌𝐃 𝐃𝐀𝐊𝐇𝐎 [𝐒𝐀𝐑𝐊𝐀𝐑](https://t.me/lll_SARKAR_lll)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://graph.org/file/f75326d087ec6539967c2.jpg.mp4",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝐓𝐊𝐒 𝐒𝐀𝐑𝐊𝐀𝐑](https://t.me/lll_SARKAR_lll)♨️
