#Powerd by @lll_SARKAR_lll
import json
import os


def get_user_list(config, key):
    with open("{}/Sarkar/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_ID = "6004468325" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "@lllSARKAR_lll"
    SUPPORT_CHAT = "https://t.me/TKS_CHAT_OFFICIAL"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001723893843
    ...
    SPAMWATCH_SUPPORT_CHAT = "@TKS_CHAT_OFFICIAL"
    ...
    DONATION_LINK = "https://t.me/lll_SARKAR_lll" # EG, paypal
    CERT_PATH = None
    PORT = 5000
